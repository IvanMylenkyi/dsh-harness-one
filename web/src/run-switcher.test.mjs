...
import { capsuleTime, SOURCE_KEY, switcherCapsules } from './run-switcher.js';
...
test('catch-up 来源有稳定翻译键（停机补跑可见），非枚举来源仍透传', () => {
  assert.equal(SOURCE_KEY['catch-up'], 'run.source.catchUp');
  const { shown } = switcherCapsules([
